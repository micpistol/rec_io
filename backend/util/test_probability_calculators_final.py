#!/usr/bin/env python3
"""
Final test script to compare original CSV probability calculator with PostgreSQL probability calculator.
"""
...
from backend.util.probability_calculator_postgresql import calculate_strike_probabilities_postgresql
...
def compare_calculators():
    ...
    print("🔍 Comparing Original CSV vs PostgreSQL Probability Calculators")
    print("=" * 70)
    ...
    for idx, row in btc_data.iterrows():
        ...
        try:
            pg_results = calculate_strike_probabilities_postgresql(current_price, 300, strikes, momentum_score)
        except Exception as e:
